...
<div class="main">
  <div class="jumbotron">
     <ched-users-force-verified></ched-users-force-verified>
  </div> 
</div>
    </div>
</template>
...
Vue.component("ched-users-force-verified", {
    template: `<div>
                  <form
  ...
  methods: {
    submit: function() {
      ...
      axios.post('ched_admin/force_verified/', this.formData).then(result => {
