...
<div class="main">
    ...
    <div class="jumbotron">
       <ched-list-of-applicant-by-tdp-rank></ched-list-of-applicant-by-tdp-rank>
    </div>
...
Vue.component("ched-list-of-applicant-by-tdp-rank", {
    template: `<div>
  ...
  methods: {
    ...
    fetchApplicantByTDPRank: function() {
            this.loading = true;
            axios.get('ched_admin/fetch_applicant_by_tdp_rank/').then(result => {
                this.loading = false;
...
Vue.component("ched-four-user-name", {
    template: `<div>
