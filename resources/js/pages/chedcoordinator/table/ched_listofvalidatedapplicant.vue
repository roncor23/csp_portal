<template>
    <div class="">
      <div class="header">
        ...
        <ched-nine-user-name></ched-nine-user-name>
        <div class="logo">
...
Vue.component("ched-nine-user-name", {
    template: `<div>
